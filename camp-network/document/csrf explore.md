...
<img src='../assets/referer.png' tip="">

_Tips：有些网站不允许图片外链，只有自家的网站才能成功显示图片，外部网站加载图片就会报错。这个功能就可以基于 `Referer` 来实现，如果该字段的值是自家网址，访问就放行。_
...
```html
<img
  src="https://www.bank.com/sendmoney?user=hacker&number=100"
